...
def policy_ratio(
    ...
    reward,
    initial_prob,
    transition_kernel_pull_train,
    transition_kernel_donothing_train,
    transition_kernel_pull_train_long,
    transition_kernel_donothing_train_long,
    transition_kernel_pull_val,
    transition_kernel_donothing_val,
    pulled_ratio,
    radius_pull,
    radius_donothing,
    N_sa_train,
    ...
    objval_mle, pi1_LP_mle_train, pi0_LP_mle_train = fluid_LP(
        0,
        number_of_timeperiods,
        number_of_states,
        reward,
    ...
    objval_mle_long, pi1_LP_mle_train_long, pi0_LP_mle_train_long = fluid_LP(
        0,
        number_of_timeperiods,
        number_of_states,
        reward,
    ...
    objval_val, pi1_LP_val, pi0_LP_val = fluid_LP(
        0,
        number_of_timeperiods,
        number_of_states,
        reward,
    ...
    infeasible_total_reward_val, _ = monte_carlo_randomized_policy_infeasible(
        pi1_LP_val,
        pi0_LP_val,
        number_of_timeperiods,
        number_of_states,
    ...
    infeasible_total_reward_mle_train_true, infeasible_active_bandit_number_mle_train_true = monte_carlo_randomized_policy_infeasible(
        pi1_LP_mle_train,
        pi0_LP_mle_train,
        number_of_timeperiods,
        number_of_states,
    ...
    infeasible_total_reward_mle_train_true_long, infeasible_active_bandit_number_mle_train_true_long = monte_carlo_randomized_policy_infeasible(
        pi1_LP_mle_train_long,
        pi0_LP_mle_train_long,
        number_of_timeperiods,
        number_of_states,
        reward,
        prob_pull,
    ...
    infeasible_total_reward_mle_train_val, infeasible_active_bandit_number_mle_train_val = monte_carlo_randomized_policy_infeasible(
        pi1_LP_mle_train,
        pi0_LP_mle_train,
        number_of_timeperiods,
        number_of_states,
    ...
    feasible_total_reward_mle_train_true_long, feasible_active_bandit_number_mle_train_true_long = monte_carlo_randomized_policy_feasible(
        pi1_LP_mle_train_long,
        pi0_LP_mle_train_long,
        number_of_timeperiods,
        number_of_states,
    ...
    feasible_total_reward_mle_train_true, feasible_active_bandit_number_mle_train_true = monte_carlo_randomized_policy_feasible(
        pi1_LP_mle_train,
        pi0_LP_mle_train,
        number_of_timeperiods,
        number_of_states,
    ...
    feasible_total_reward_mle_train_val, feasible_active_bandit_number_mle_train_val = monte_carlo_randomized_policy_feasible(
        pi1_LP_mle_train,
        pi0_LP_mle_train,
        number_of_timeperiods,
        number_of_states,
    ...
    #     change = 0,
    # )
    Robjval_mle_noc_b_train, Rpi1_LP_mle_noc_b_train, Rpi0_LP_mle_noc_b_train = constant_decision_rule_LP(
        0,
        number_of_timeperiods,
        number_of_states,
        reward,
    ...
    #     init_prob,
    # )
    infeasible_Rtotal_reward_mle_noc_b_train_true, infeasible_active_bandit_number_Rmle_noc_b_train_true = monte_carlo_randomized_policy_infeasible(
        Rpi1_LP_mle_noc_b_train,
        Rpi0_LP_mle_noc_b_train,
        number_of_timeperiods,
        number_of_states,
        reward,
        prob_pull,
    ...
    infeasible_Rtotal_reward_mle_noc_b_train_val, infeasible_active_bandit_number_Rmle_noc_b_train_val = monte_carlo_randomized_policy_infeasible(
        Rpi1_LP_mle_noc_b_train,
        Rpi0_LP_mle_noc_b_train,
        number_of_timeperiods,
        number_of_states,
    ...
    #     init_prob,
    # )
    feasible_Rtotal_reward_mle_noc_b_train_true, feasible_active_bandit_number_Rmle_noc_b_train_true = monte_carlo_randomized_policy_feasible(
        Rpi1_LP_mle_noc_b_train,
        Rpi0_LP_mle_noc_b_train,
        number_of_timeperiods,
        number_of_states,
    ...
    feasible_Rtotal_reward_mle_noc_b_train_val, feasible_active_bandit_number_Rmle_noc_b_train_val = monte_carlo_randomized_policy_feasible(
        Rpi1_LP_mle_noc_b_train,
        Rpi0_LP_mle_noc_b_train,
        number_of_timeperiods,
        number_of_states,
    ...
    Robjval_mle_c_b_train, Rpi1_LP_mle_c_b_train, Rpi0_LP_mle_c_b_train = constant_decision_rule_LP(
        0,
        number_of_timeperiods,
        number_of_states,
        reward,
    ...
    infeasible_Rtotal_reward_mle_c_b_train_true, infeasible_active_bandit_number_Rmle_c_b_train_true = monte_carlo_randomized_policy_infeasible(
        Rpi1_LP_mle_c_b_train,
        Rpi0_LP_mle_c_b_train,
        number_of_timeperiods,
        number_of_states,
        reward,
        prob_pull,
    ...
    infeasible_Rtotal_reward_mle_c_b_train_val, infeasible_active_bandit_number_Rmle_c_b_train_val = monte_carlo_randomized_policy_infeasible(
        Rpi1_LP_mle_c_b_train,
        Rpi0_LP_mle_c_b_train,
        number_of_timeperiods,
        number_of_states,
    ...
    feasible_Rtotal_reward_mle_c_b_train_true, feasible_active_bandit_number_Rmle_c_b_train_true = monte_carlo_randomized_policy_feasible(
        Rpi1_LP_mle_c_b_train,
        Rpi0_LP_mle_c_b_train,
        number_of_timeperiods,
        number_of_states,
    ...
    feasible_Rtotal_reward_mle_c_b_train_val, feasible_active_bandit_number_Rmle_c_b_train_val = monte_carlo_randomized_policy_feasible(
        Rpi1_LP_mle_c_b_train,
        Rpi0_LP_mle_c_b_train,
        number_of_timeperiods,
        number_of_states,
    ...
    infeasible_total_reward_mle_online_unmixed_train_true, infeasible_active_bandit_number_mle_online_unmixed_train_true = (
    ...
    infeasible_total_reward_mle_online_unmixed_train_val, infeasible_active_bandit_number_mle_online_unmixed_train_val = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_mle_online_unmixed_train_true, feasible_active_bandit_number_mle_online_unmixed_train_true = (
    ...
    feasible_total_reward_mle_online_unmixed_train_val, feasible_active_bandit_number_mle_online_unmixed_train_val = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    infeasible_total_reward_Rmle_online_unmixed_train_true, infeasible_active_bandit_number_Rmle_online_unmixed_train_true = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    infeasible_total_reward_Rmle_online_unmixed_train_val, infeasible_active_bandit_number_Rmle_online_unmixed_train_val = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_Rmle_online_unmixed_train_true, feasible_active_bandit_number_Rmle_online_unmixed_train_true = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_Rmle_online_unmixed_train_val, feasible_active_bandit_number_Rmle_online_unmixed_train_val = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    infeasible_total_reward_mle_online_mixed_train_true, infeasible_active_bandit_number_mle_online_mixed_train_true = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    infeasible_total_reward_mle_online_mixed_train_val, infeasible_active_bandit_number_mle_online_mixed_train_val = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_mle_online_mixed_train_true, feasible_active_bandit_number_mle_online_mixed_train_true = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_mle_online_mixed_train_val, feasible_active_bandit_number_mle_online_mixed_train_val = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    infeasible_total_reward_Rmle_online_mixed_train_true, infeasible_active_bandit_number_Rmle_online_mixed_train_true = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    infeasible_total_reward_Rmle_online_mixed_train_val, infeasible_active_bandit_number_Rmle_online_mixed_train_val = (
        monte_carlo_randomized_policy_infeasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_Rmle_online_mixed_train_true, feasible_active_bandit_number_Rmle_online_mixed_train_true = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    feasible_total_reward_Rmle_online_mixed_train_val, feasible_active_bandit_number_Rmle_online_mixed_train_val = (
        monte_carlo_randomized_policy_feasible_online(
            number_of_timeperiods,
            number_of_states,
            reward,
    ...
    return np.array(
        [   infeasible_total_reward_mle_train_val / infeasible_total_reward_val,
            feasible_total_reward_mle_train_val / infeasible_total_reward_val,
            infeasible_Rtotal_reward_mle_noc_b_train_val / infeasible_total_reward_val,
            feasible_Rtotal_reward_mle_noc_b_train_val / infeasible_total_reward_val,
            infeasible_Rtotal_reward_mle_c_b_train_val / infeasible_total_reward_val,
            feasible_Rtotal_reward_mle_c_b_train_val / infeasible_total_reward_val,           
            infeasible_total_reward_mle_online_unmixed_train_val
            / infeasible_total_reward_val,
            feasible_total_reward_mle_online_unmixed_train_val
            / infeasible_total_reward_val,
            infeasible_total_reward_Rmle_online_unmixed_train_val
            / infeasible_total_reward_val,
            feasible_total_reward_Rmle_online_unmixed_train_val
            / infeasible_total_reward_val,
            infeasible_total_reward_mle_online_mixed_train_val
            / infeasible_total_reward_val,
            feasible_total_reward_mle_online_mixed_train_val
            / infeasible_total_reward_val,
            infeasible_total_reward_Rmle_online_mixed_train_val
            / infeasible_total_reward_val,
            feasible_total_reward_Rmle_online_mixed_train_val
            / infeasible_total_reward_val,
            infeasible_total_reward_mle_train_true / infeasible_total_reward_true,
            feasible_total_reward_mle_train_true / infeasible_total_reward_true,
            infeasible_Rtotal_reward_mle_noc_b_train_true / infeasible_total_reward_true,
            feasible_Rtotal_reward_mle_noc_b_train_true / infeasible_total_reward_true,
            infeasible_Rtotal_reward_mle_c_b_train_true / infeasible_total_reward_true,
            feasible_Rtotal_reward_mle_c_b_train_true / infeasible_total_reward_true,           
            infeasible_total_reward_mle_online_unmixed_train_true
            / infeasible_total_reward_true,
            feasible_total_reward_mle_online_unmixed_train_true
            / infeasible_total_reward_true,
            infeasible_total_reward_Rmle_online_unmixed_train_true
            / infeasible_total_reward_true,
            feasible_total_reward_Rmle_online_unmixed_train_true
            / infeasible_total_reward_true,
            infeasible_total_reward_mle_online_mixed_train_true
            / infeasible_total_reward_true,
            feasible_total_reward_mle_online_mixed_train_true
            / infeasible_total_reward_true,
            infeasible_total_reward_Rmle_online_mixed_train_true
            / infeasible_total_reward_true,
            feasible_total_reward_Rmle_online_mixed_train_true
            / infeasible_total_reward_true,            
            infeasible_total_reward_mle_train_true_long / infeasible_total_reward_true,
            feasible_total_reward_mle_train_true_long / infeasible_total_reward_true,
        ]
    ), np.array(
        [   
            infeasible_active_bandit_number_mle_train_val, 
            feasible_active_bandit_number_mle_train_val, 
            infeasible_active_bandit_number_Rmle_noc_b_train_val, 
            feasible_active_bandit_number_Rmle_noc_b_train_val, 
            infeasible_active_bandit_number_Rmle_c_b_train_val, 
            feasible_active_bandit_number_Rmle_c_b_train_val, 
            infeasible_active_bandit_number_mle_online_unmixed_train_val, 
            feasible_active_bandit_number_mle_online_unmixed_train_val, 
            infeasible_active_bandit_number_Rmle_online_unmixed_train_val, 
            feasible_active_bandit_number_Rmle_online_unmixed_train_val, 
            infeasible_active_bandit_number_mle_online_mixed_train_val, 
            feasible_active_bandit_number_mle_online_mixed_train_val, 
            infeasible_active_bandit_number_Rmle_online_mixed_train_val, 
            feasible_active_bandit_number_Rmle_online_mixed_train_val,
            infeasible_active_bandit_number_mle_train_true, 
            feasible_active_bandit_number_mle_train_true, 
            infeasible_active_bandit_number_Rmle_noc_b_train_true, 
            feasible_active_bandit_number_Rmle_noc_b_train_true, 
            infeasible_active_bandit_number_Rmle_c_b_train_true, 
            feasible_active_bandit_number_Rmle_c_b_train_true, 
            infeasible_active_bandit_number_mle_online_unmixed_train_true, 
            feasible_active_bandit_number_mle_online_unmixed_train_true, 
            infeasible_active_bandit_number_Rmle_online_unmixed_train_true, 
            feasible_active_bandit_number_Rmle_online_unmixed_train_true, 
            infeasible_active_bandit_number_mle_online_mixed_train_true, 
            feasible_active_bandit_number_mle_online_mixed_train_true, 
            infeasible_active_bandit_number_Rmle_online_mixed_train_true, 
            feasible_active_bandit_number_Rmle_online_mixed_train_true,
            infeasible_active_bandit_number_mle_train_true_long,
            feasible_active_bandit_number_mle_train_true_long  
        ]
        )
...
def get_single_sample(
    ...
    N_sa_train_long, N_sas_train_long, initial_prob = calculate_mle_transition_count(
        sample_paths,
        0,
        path_length - 1,
        number_of_bandit_in_total,
    ...
    N_sa_train, N_sas_train, _ = calculate_mle_transition_count(
        sample_paths,
        start_time_train,
        end_time_train,
        number_of_bandit_in_total,
    ...
    N_sa_val, N_sas_val, _ = calculate_mle_transition_count(
        sample_paths,
        start_time_val,
        end_time_val,
        number_of_bandit_in_total,
    ...
    transition_kernel_pull_train_long, transition_kernel_donothing_train_long = count_to_kernel(
        N_sa_train_long,
        N_sas_train_long,
        number_of_bandit_in_total,
        number_of_states,
    ...
    transition_kernel_pull_train, transition_kernel_donothing_train = count_to_kernel(
        N_sa_train,
        N_sas_train,
        number_of_bandit_in_total,
        number_of_states,
    ...
    transition_kernel_pull_val, transition_kernel_donothing_val = count_to_kernel(
        N_sa_val,
        N_sas_val,
        number_of_bandit_in_total,
        number_of_states,
...
def main_mp(num_proc: int = 256):
    ...
    for path_length in path_length_list:
        start_time_train = 0
        end_time_train = path_length - 10
        start_time_val = end_time_train
        ...
        # save the results
        np.save(f"results_RWCMDP/results_policy_ratio_val3.0_{path_length}.npy", results)
        del results
